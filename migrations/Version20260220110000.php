...
final class Version20260220110000 extends AbstractMigration
{
    ...
    {
        return 'Schema: patients, dentists, boxes, visits, treatment, pathologies, teeth, odontogram_details, documents';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE patients (patient_id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, national_id VARCHAR(20) NOT NULL, first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, social_security_number VARCHAR(50) DEFAULT NULL, phone VARCHAR(50) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, billing_information TEXT DEFAULT NULL, reason_for_consultation TEXT DEFAULT NULL, family_history TEXT DEFAULT NULL, health_status TEXT DEFAULT NULL, lifestyle_habits TEXT DEFAULT NULL, medication_allergies TEXT DEFAULT NULL, registration_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY (patient_id))');
        ...
        $this->addSql('CREATE TABLE dentists (doctor_id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, first_name VARCHAR(100) NOT NULL, last_name VARCHAR(200) NOT NULL, specialty VARCHAR(100) NOT NULL, assigned_day_of_week VARCHAR(20) NOT NULL, phone VARCHAR(50) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, PRIMARY KEY (doctor_id))');
        $this->addSql('CREATE INDEX idx_dentist_email ON dentists (email)');

        $this->addSql('CREATE TABLE boxes (id_box INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, box_name VARCHAR(50) NOT NULL, status VARCHAR(20) NOT NULL, capacity INT DEFAULT 2 NOT NULL, PRIMARY KEY (id_box))');
        ...
        $this->addSql('CREATE TABLE visits (id_visit INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, id_patient INT NOT NULL, id_doctor INT NOT NULL, id_box INT NOT NULL, id_treatment INT DEFAULT NULL, date_visit DATE NOT NULL, time_visit TIME(0) WITHOUT TIME ZONE NOT NULL, reason_for_consultation TEXT DEFAULT NULL, notes TEXT DEFAULT NULL, PRIMARY KEY (id_visit))');
        ...
        $this->addSql('ALTER TABLE visits ADD CONSTRAINT FK_444839EAD8177B3F FOREIGN KEY (id_box) REFERENCES boxes (id_box) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
